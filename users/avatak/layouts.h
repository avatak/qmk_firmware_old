...
#define __ADJ_R1___________________________________     RGBRST , RGB_VAD, RGB_HUI, RGB_VAI, _______
#define __ADJ_R2___________________________________     _______,RGB_RMOD, RGB_HUD, RGB_MOD, _______
#define __ADJ_R3___________________________________     _______, RGB_SAI, RGB_M_P, RGB_SAI, _______
