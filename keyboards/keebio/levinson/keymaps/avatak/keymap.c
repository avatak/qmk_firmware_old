...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_CLMK] = LAYOUT_wrapper( \
        ...
        KC_LSFT, __CLMK_L3__________________________________, __CLMK_R3__________________________________, KC_ENT , \
        KC_LCTL, KC_LGUI, KC_LALT, _______, NAVSPC , NAVSPC , TEXSPC , TEXSPC , _______, ALTCTL , ALTSHFT, ADJUST \
    ),
    ...
    [_NUM] =  LAYOUT_wrapper( \
        ...
        _______, _______, _______, _______, _______, _______, KC_P0  , KC_P0  , KC_PDOT, KC_PENT, _______, _______ \
    ),

    [_ADJ] =  LAYOUT_wrapper( \
        RESET  , __ADJ_L1___________________________________, __ADJ_R1___________________________________, _______, \
        _______, __ADJ_L2___________________________________, __ADJ_R2___________________________________, _______, \
        _______, __ADJ_L3___________________________________, __ADJ_R3___________________________________, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ \
    ),
