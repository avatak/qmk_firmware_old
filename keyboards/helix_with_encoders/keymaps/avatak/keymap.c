...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MNAV] = LAYOUT_wrapper(
        _______, __MNAV_L0__________________________________,                   _______, _______, _______, _______, _______, _______,
        MACWIN , __MNAV_L1__________________________________,                   __MNAV_R1__________________________________, ALT_F2 ,
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, MACTERM
    ),
