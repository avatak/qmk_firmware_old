...
/* Custom keycode definitions */
    ...
    /* Layer changes: 
     * for info on the differences between MO, LT, TT (and other options), see
     ...
     * Various combined keycodes, e.g. LALT(KC_BSPC) means it activates left alt then backspace at the same time */
    ...
    /* Dual function keys: GUI_T(KC) means hold to activate GUI (windows key) or tap to activate KC */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   /* Adjustment layer
    *  ,-----------------------------------------------.               ,-----------------------------------------------.
    *  | Reset |       |       |       |       |       |               |RGB_Toggle|    |       |       |       |RST RGB|
    *  |-------+-------+-------+-------+-------+-------|               |-------+-------+-------+-------+-------+-------|
    *  |       |       |       |+Brght |       |       |               |+Spd   |+Hue   |       |       |       |       |
    *  |-------+-------+-------+-------+-------+-------|               |-------+-------+-------+-------+-------+-------|
    *  |       |Aud Tog|-Sat   |-Brght |+Sat   |       |               |-Spd   |-Hue   | > ||  | + VOL |       |       |
    *  |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
    *  |       |       |-ClkFrq|ClkTog |+ClkFrq|       |       |       |PrvMode|NxtMode| PREV  | - VOL | NEXT  |       |
    *  |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
    *  |       |       |       |       |       |       |       |       |       |       |       | MUTE  |       |       |
    *  `---------------------------------------------------------------------------------------------------------------'
    *                  \    RGB CONTROL       /                        \ RGB CONTROL   /\ MEDIA CONTROL        / 
    *          \       AUDIO CONTROL          /
    */
    ...
    [_ADJUST] = LAYOUT(
        ...
        _______, AU_TOG , RGB_SAD, RGB_VAD, RGB_SAI, _______,                   RGB_SPD, RGB_HUD, KC_MPLY, KC_VOLU, _______, _______,
        _______, _______, CK_DOWN, CK_TOGG, CK_UP  , _______, _______, _______,RGB_RMOD, RGB_MOD, KC_MPRV, KC_VOLD, KC_MNXT, _______,
