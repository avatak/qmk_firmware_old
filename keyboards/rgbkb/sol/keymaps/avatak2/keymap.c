...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MNAV] = LAYOUT_wrapper( \
    ...
    [_NUM] = LAYOUT_wrapper( \J
        _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______,J __NP_0____________________________, \
        _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______,J __NP_1____________________________, \
