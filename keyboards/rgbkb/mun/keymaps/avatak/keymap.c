...
//      3 touch buttons, then swipe up and down
    ...
    [_NUM] = LAYOUT_wrapper( \
        _______, _______, _______, _______, _______, _______, _______,          _______, KC_NLCK, KC_PSLS, KC_PAST, KC_PEQL, _______, _______, \
        ...
        _______, _______, _______, _______, _______, _______, _______,          KC_TAB , KC_P1  , KC_P2  , KC_P3  , KC_PDOT, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______,          KC_PENT, KC_P0  , KC_P0  , _______, KC_COMM, _______, _______, \
