...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_COLEMAK] = LAYOUT_wrapper(
        ...
        ADJUST , KC_LCTL, KC_LGUI, KC_LALT, NAVSPC , NAVSPC , NUMTAP , SYMENT , TEXSPC , TEXSPC , _______, ALTSHFT, ALTCTL , _______,
    ...
    [_NAV] = LAYOUT_wrapper(
        ...
        _______, __NAV_L3___________________________________, _______, REDOIT , __NAV_R3___________________________________, _______,
    ...
    [_SYM] = LAYOUT_wrapper(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, __SYM_L1___________________________________, _______, _______, __SYM_R1___________________________________, _______,
        _______, __SYM_L2___________________________________, _______, _______, __SYM_R2___________________________________, _______,
    ...
    [_NUM] = LAYOUT_wrapper(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, __NP_0____________________________, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, __NP_1____________________________, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, __NP_2____________________________, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, __NP_3____________________________, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, __NP_4____________________________, _______,
    ...
    [_UTIL] = LAYOUT_wrapper(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, UPRGHT , KC_UP  , DOWNRGHT,_______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, KC_ENT , KC_ENT , _______, _______, _______, _______, _______, _______, _______, _______,
