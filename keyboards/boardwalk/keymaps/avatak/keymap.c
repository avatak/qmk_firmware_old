 ...
 */
 ...
 [_COLEMAK] = LAYOUT_wrap(
    ...
    ADJUST , KC_LCTL, _______, KC_LGUI, KC_LALT, NAVSPC , MO(_NUM), SYMENT , TEXSPC , _______, _______, _______, _______, ADJUST  \
 ),
...
[_COLEMAC] = LAYOUT_wrap(
    ...
    ADJUST , KC_LCTL, _______, KC_LGUI, KC_LALT, MNAVSPC, MNAVSPC, SYMENT , TEXSPC , _______, _______, _______, _______, ADJUST  \
),
...
[_ADJUST] = LAYOUT_wrap(
    ...
    _______, _______, _______, _______, _______, COLEMAK, COLEMAC, _______, _______, _______, _______, _______, KC_MUTE, _______ \
)
